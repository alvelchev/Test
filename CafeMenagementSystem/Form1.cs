...
namespace HotelMenagementSystem
{
    ...
    public partial class Form1 : Form
    {
        ...
        public List<Product> productsList2;
        public Form1(string userName,List<Product> productsListTest)
        {
            this.userName1 = userName;
            productsList = new List<Product>();
            productsList2 = productsListTest;
        ...
        private void buttonCheckOut_Click(object sender, EventArgs e)
        {
            ...
            //FileStream f = File.Open(@"D:\productsList.txt", FileMode.Open, FileAccess.Write);
            ...
            if (productsList2 == null)
            {
                ...
                CheckOutForm checkOut = new CheckOutForm(userName1, TotalBill.Text, productsList, false);
                this.Hide();
                checkOut.ShowDialog();
            }
            else
            {
                ...
                CheckOutForm checkOut = new CheckOutForm(userName1, TotalBill.Text, productsList2, false);
                this.Hide();
                checkOut.ShowDialog();
            }
